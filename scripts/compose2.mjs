...
// Find exactly where the function signature is and replace it
const sigRegex = /export function DesignEditorInner\(\{ onBack, initialScene \}: \{ onBack: \(\) => void; initialScene\?: any \}\) \{/
const newSig = `
...
// Find the FIRST `return (` which is the main render of the component
// Since there might be other returns, we will replace the first one.
let replacedReturn = false
content = content.replace(/return \(/g, (match) => {
...
// We can just find the end of the file and append the closing tags.
