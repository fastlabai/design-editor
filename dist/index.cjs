...
var FrameObject = class extends fabric.fabric.Rect {
  ...
  static fromObject(options, callback) {
    return callback && callback(new fabric.fabric.Frame(options));
  }
};
fabric.fabric.Frame = fabric.fabric.util.createClass(FrameObject, {
  type: FrameObject.type
});
fabric.fabric.Frame.fromObject = FrameObject.fromObject;
var StaticTextObject = class extends fabric.fabric.Textbox {
  ...
  toObject(propertiesToInclude = []) {
    return fabric.fabric.util.object.extend(super.toObject.call(this, propertiesToInclude), {
  ...
  static fromObject(options, callback) {
    return callback && callback(new fabric.fabric.StaticText(options));
  }
};
fabric.fabric.StaticText = fabric.fabric.util.createClass(StaticTextObject, {
  type: StaticTextObject.type
});
fabric.fabric.StaticText.fromObject = StaticTextObject.fromObject;
var StaticImageObject = class extends fabric.fabric.Image {
  ...
  static fromObject(options, callback) {
    fabric.fabric.util.loadImage(
      options.src,
      function(img) {
        return callback && callback(new fabric.fabric.StaticImage(img, options));
      },
      null,
      // @ts-ignore
...
fabric.fabric.StaticImage = fabric.fabric.util.createClass(StaticImageObject, {
  type: StaticImageObject.type
});
fabric.fabric.StaticImage.fromObject = StaticImageObject.fromObject;

// src/engine/objects/StaticVector.ts
var import_groupBy = __toESM(require_groupBy());
var StaticVectorObject = class extends fabric.fabric.Group {
  ...
  initialize(objects, options, others) {
    ...
    const object = fabric.fabric.util.groupSVGElements(objects, options);
  ...
  static fromObject(options, callback) {
    fabric.fabric.loadSVGFromURL(options.src, (objects, opts) => {
      return callback && callback(new fabric.fabric.StaticVector(objects, opts, { ...options }));
    });
  }
};
fabric.fabric.StaticVector = fabric.fabric.util.createClass(StaticVectorObject, {
  type: StaticVectorObject.type
});
fabric.fabric.StaticVector.fromObject = StaticVectorObject.fromObject;
var StaticPathObject = class extends fabric.fabric.Path {
  ...
  static fromObject(options, callback) {
    return callback && callback(new fabric.fabric.StaticPath(options));
  }
};
fabric.fabric.StaticPath = fabric.fabric.util.createClass(StaticPathObject, {
  type: StaticPathObject.type
});
fabric.fabric.StaticPath.fromObject = StaticPathObject.fromObject;
var defaultShadow = {
  blur: 10,
  color: "#C7C7C7",
  offsetX: 0,
...
var BackgroundObject = class extends fabric.fabric.Rect {
  static type = "Background";
  initialize(options) {
    const shadowOptions = options.shadow ? options.shadow : defaultShadow;
    const shadow = new fabric.fabric.Shadow({
      affectStroke: false,
      // @ts-ignore
      ...shadowOptions
    });
  ...
  static fromObject(options, callback) {
    return callback && callback(new fabric.fabric.Background(options));
  }
};
fabric.fabric.Background = fabric.fabric.util.createClass(BackgroundObject, {
  type: BackgroundObject.type
});
fabric.fabric.Background.fromObject = BackgroundObject.fromObject;
var BackgroundImageObject = class extends fabric.fabric.Image {
  ...
  static fromObject(options, callback) {
    fabric.fabric.util.loadImage(
      options.src,
      function(img) {
        return callback && callback(new fabric.fabric.BackgroundImage(img, options));
      },
      null,
      // @ts-ignore
      { crossOrigin: "anonymous" }
...
fabric.fabric.BackgroundImage = fabric.fabric.util.createClass(BackgroundImageObject, {
  type: BackgroundImageObject.type
});
fabric.fabric.BackgroundImage.fromObject = BackgroundImageObject.fromObject;
var StaticVideoObject = class extends fabric.fabric.Image {
...
fabric.fabric.StaticVideo = fabric.fabric.util.createClass(StaticVideoObject, {
  type: StaticVideoObject.type
});
var StaticAudioObject = class extends fabric.fabric.Object {
  ...
  static fromObject(options, callback) {
    return callback && callback(new fabric.fabric.StaticAudio(options));
  }
};
fabric.fabric.StaticAudio = fabric.fabric.util.createClass(StaticAudioObject, {
  type: StaticAudioObject.type
});
fabric.fabric.StaticAudio.fromObject = StaticAudioObject.fromObject;
...
var Canvas = class {
  ...
  initialize = () => {
    const canvas = new fabric.fabric.Canvas(this.canvasId, {
  ...
  resize({ width, height }) {
    ...
    const deltaPoint = new fabric.fabric.Point(diffWidth, diffHeight);
...
var setObjectShadow = (object, options) => {
  if (options.enabled) {
    object.set({
      shadow: new fabric.fabric.Shadow(options)
    });
  } else {
    object.set({
      shadow: null
...
var Frame = class extends Base_default {
  ...
  initialize() {
    const frame = new fabric.fabric.Frame({
      ...defaultFrameOptions,
      absolutePositioned: this.config.clipToFrame
    });
    const background = new fabric.fabric.Background({
  ...
  setBackgroundColor = (color) => {
    ...
    if (!background) {
      background = new fabric.fabric.Background({
...
var Zoom = class extends Base_default {
  zoomIn() {
    ...
    this.zoomToPoint(new fabric.fabric.Point(center.left, center.top), zoomRatio);
  ...
  zoomToOne() {
    ...
    this.zoomToPoint(new fabric.fabric.Point(center.left, center.top), 1);
  ...
  zoomToFit() {
    ...
    const center = this.canvas.getCenter();
    this.canvas.setViewportTransform([1, 0, 0, 1, 0, 0]);
    this.zoomToPoint(new fabric.fabric.Point(center.left, center.top), zoomFitRatio);
...
var History = class extends Base_default {
  ...
  initialize = () => {
    ...
    canvasJSON.objects.forEach((object) => {
      if (object.clipPath) {
        fabric.fabric.util.enlivenObjects(
          [object.clipPath],
          function(arg1) {
  ...
  staticText(item, options, inGroup) {
    return new Promise((resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.StaticText(textOptions);
  ...
  staticImage(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.StaticImage(image, {
          ...baseOptions,
          cropX: cropX || 0,
          cropY: cropY || 0
        });
  ...
  backgroundImage(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.BackgroundImage(image, {
          ...baseOptions,
          cropX: cropX || 0,
          cropY: cropY || 0
        });
  ...
  staticVideo(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.StaticVideo(videoElement, {
          ...baseOptions,
          src,
  ...
  staticAudio(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        const baseOptions = this.getBaseOptions(item, options, inGroup);
        const { src } = item;
        const element = new fabric.fabric.StaticAudio({
          ...baseOptions,
          src
        });
        resolve(element);
  ...
  staticPath(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.StaticPath({
          ...baseOptions,
          // @ts-ignore
          path: path2,
          fill
  ...
  group(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.Group(objects, { ...baseOptions, subTargetCheck: true });
        updateObjectBounds(element, options);
        updateObjectShadow(element, item.shadow);
        resolve(element);
      } catch (err) {
  ...
  background(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        const baseOptions = this.getBaseOptions(item, options, inGroup);
        const { fill } = item;
        const element = new fabric.fabric.Background({
          ...baseOptions,
          fill,
          // @ts-ignore
          shadow: item.shadow
  ...
  staticVector(item, options, inGroup) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        fabric.fabric.loadSVGFromURL(src, (objects, opts) => {
          const { width, height } = baseOptions;
          if (!width || !height) {
          ...
          const element = new fabric.fabric.StaticVector(objects, opts, {
            ...baseOptions,
            src,
            colorMap
          });
...
var Objects = class extends Base_default {
  ...
  select = (id) => {
    ...
    if (id) {
      ...
      const activeSelection = new fabric.fabric.ActiveSelection(filteredObjects, {
        canvas: this.canvas
      });
  ...
  clone = () => {
    if (this.canvas) {
      ...
      this.duplicate(activeObject, frame, (duplicates) => {
        const selection = new fabric.fabric.ActiveSelection(duplicates, {
          canvas: this.canvas
        });
  ...
  duplicate(object, frame, callback) {
    if (object instanceof fabric.fabric.Group && object.type !== "StaticVector" /* STATIC_VECTOR */) {
  ...
  pasteStyle = () => {
    ...
    if (activeObject && this.copyStyleClipboard) {
      if (activeObject.type === this.copyStyleClipboard.objectType) {
        ...
        if (fill) {
          if (fill.type) {
            activeObject.set({ fill: new fabric.fabric.Gradient(fill) });
          } else {
  ...
  alignTop = (id) => {
    ...
    if (refObject) {
      if (refObject.type === "activeSelection" /* ACTIVE_SELECTION */) {
        ...
        const selection = new fabric.fabric.ActiveSelection(selectedObjects, {
          canvas: this.canvas
        });
        this.canvas.setActiveObject(selection);
  ...
  unsetBackgroundImage() {
    return new Promise(async (resolve) => {
      ...
      if (currentBackgroundImage) {
        ...
        nextImage = new fabric.fabric.StaticImage(nextImageElement, { ...currentBackgroundImageJSON, id: generateId() });
  ...
  async setAsBackgroundImage(id) {
    ...
    if (refObject && refObject.type === "StaticImage" /* STATIC_IMAGE */) {
      ...
      const backgroundImage = new fabric.fabric.BackgroundImage(image, { ...objectJSON, id: generateId() });
  ...
  setShadow = (options) => {
    const activeObject = this.canvas.getActiveObject();
    if (activeObject instanceof fabric.fabric.Group && activeObject.type !== "StaticVector" /* STATIC_VECTOR */) {
  ...
  setGradient = ({ angle, colors }) => {
    const activeObject = this.canvas.getActiveObject();
    if (activeObject instanceof fabric.fabric.Group) {
      activeObject._objects.forEach((object) => {
...
var Events = class extends Base_default {
  ...
  objectModified = (event) => {
    const { target } = event;
    if (target instanceof fabric.fabric.Textbox) {
  ...
  handleZoom = (event) => {
    ...
    this.editor.zoom.zoomToPoint(new fabric.fabric.Point(this.canvas.getWidth() / 2, this.canvas.getHeight() / 2), zoomRatio);
...
async function parseSVG(url) {
  return new Promise((resolve, reject) => {
    fabric.fabric.loadSVGFromURL(url, (objects, summary) => {
      const frame = {
        width: summary.width,
  ...
  exportAsComponent = async () => {
    ...
    if (activeObject && selectionType) {
      ...
      if (activeObject.type === "activeSelection" || activeObject.type === "group") {
        ...
        const group = new fabric.fabric.Group(clonedObjects);
  ...
  group(item, params) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const element = new fabric.fabric.Group(objects, baseOptions);
        updateObjectShadow(element, item.shadow);
        resolve(element);
      } catch (err) {
        reject(err);
...
var Personalization = class extends Base_default {
  ...
  init() {
    ...
    fabric.fabric.util.addListener(document.getElementsByClassName("upper-canvas")[0], "contextmenu", function(e) {
      e.preventDefault();
    });
    fabric.fabric.Object.prototype.transparentCorners = false;
    fabric.fabric.Object.prototype.cornerColor = "#20bf6b";
    fabric.fabric.Object.prototype.cornerStyle = "circle";
    fabric.fabric.Object.prototype.borderColor = "#3782F7";
    fabric.fabric.Object.prototype.cornerSize = 12;
    fabric.fabric.Object.prototype.borderScaleFactor = 2.25;
    fabric.fabric.Object.prototype.borderOpacityWhenMoving = 1;
    fabric.fabric.Object.prototype.borderOpacity = 1;
    fabric.fabric.Object.prototype.controls.tr = new fabric.fabric.Control({
      ...
      actionName: fabric.fabric.controlsUtils.scaleOrSkewActionName,
    ...
    fabric.fabric.Textbox.prototype.controls.tr = fabric.fabric.Object.prototype.controls.tr;
    fabric.fabric.Textbox.prototype.controls.tl = fabric.fabric.Object.prototype.controls.tl;
    fabric.fabric.Textbox.prototype.controls.bl = fabric.fabric.Object.prototype.controls.bl;
    fabric.fabric.Textbox.prototype.controls.br = fabric.fabric.Object.prototype.controls.br;
    fabric.fabric.Textbox.prototype.controls.mt = new fabric.fabric.Control({
      render: () => true
    });
    fabric.fabric.Textbox.prototype.controls.mb = fabric.fabric.Textbox.prototype.controls.mt;
    fabric.fabric.Textbox.prototype.controls.mr = new fabric.fabric.Control({
      x: 0.5,
      y: 0,
      actionHandler: fabric.fabric.controlsUtils.changeWidth,
      cursorStyleHandler: fabric.fabric.controlsUtils.scaleSkewCursorStyleHandler,
      actionName: "resizing",
      render: drawCircleIcon,
      cornerSize: 28,
    ...
    fabric.fabric.Textbox.prototype.controls.ml = new fabric.fabric.Control({
      x: -0.5,
      y: 0,
      actionHandler: fabric.fabric.controlsUtils.changeWidth,
      cursorStyleHandler: fabric.fabric.controlsUtils.scaleSkewCursorStyleHandler,
    ...
    fabric.fabric.Textbox.prototype.controls.mtr = new fabric.fabric.Control({
      x: 0,
      y: 0.5,
      offsetY: 30,
      actionHandler: fabric.fabric.controlsUtils.rotationWithSnapping,
      ...
      for (var i = canvasObjects.length; i--; ) {
        ...
        if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft - activeObjectWidth / 2, backgroundImageMargin)) {
          ...
          activeObject.setPositionByOrigin(
            new fabric.fabric.Point(objectLeft - objectWidth / 2 + activeObjectWidth / 2, activeObjectTop),
            "center",
            "center"
          );
        }
        ...
        if (isInRange(objectTop - objectHeight / 2, activeObjectTop - activeObjectHeight / 2, backgroundImageMargin)) {
          ...
          activeObject.setPositionByOrigin(
            new fabric.fabric.Point(activeObjectLeft, objectTop - objectHeight / 2 + activeObjectHeight / 2),
            "center",
            "center"
          );
        }
...
var Button = React24__namespace.forwardRef(
  ({ variant = "secondary", size = "md", iconOnly, className, ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      className: clsx.clsx("de-btn", className),
      ...rest
    }
  )
);
...
function Popover({ children, content, open, onOpenChange, placement = "bottom", contentClassName }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(RadixPopover__namespace.Root, { open, onOpenChange, children: [
    /* @__PURE__ */ jsxRuntime.jsx(RadixPopover__namespace.Trigger, { asChild: true, children }),
    /* @__PURE__ */ jsxRuntime.jsx(RadixPopover__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsxs(
      RadixPopover__namespace.Content,
      {
        side: placement,
        sideOffset: 4,
        className: clsx.clsx("de-popover-content", contentClassName),
        children: [
          content,
          /* @__PURE__ */ jsxRuntime.jsx(RadixPopover__namespace.Arrow, { className: "de-popover-arrow", width: 10, height: 5 })
        ]
      }
    ) })
  ] });
...
var Input = React24__namespace.forwardRef(
  ({ className, size = "md", ...rest }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
    "input",
    {
      ref,
      "data-size": size,
      className: clsx.clsx("de-input", className),
      ...rest
    }
  )
);
...
var Tooltip = React24__namespace.forwardRef(({ children, title, placement = "top", className }, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(RadixTooltip__namespace.Provider, { delayDuration: 200, children: /* @__PURE__ */ jsxRuntime.jsxs(RadixTooltip__namespace.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(RadixTooltip__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsxs(
      RadixTooltip__namespace.Content,
      {
        side: placement,
        sideOffset: 4,
        className: clsx.clsx("de-tooltip-content", className),
        children: [
          title,
          /* @__PURE__ */ jsxRuntime.jsx(RadixTooltip__namespace.Arrow, { className: "de-tooltip-arrow", width: 8, height: 4 })
        ]
      }
    ) })
  ] }) });
...
var Select = React24__namespace.forwardRef(({ value, defaultValue, onValueChange, options, placeholder, className, style }, ref) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(RadixSelect__namespace.Root, { value, defaultValue, onValueChange, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(RadixSelect__namespace.Trigger, { ref, className: clsx.clsx("de-select-trigger", className), style, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.Icon, { children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819L7.43179 8.56819C7.60753 8.74393 7.89245 8.74393 8.06819 8.56819L10.5682 6.06819C10.7439 5.89245 10.7439 5.60753 10.5682 5.43179C10.3924 5.25605 10.1075 5.25605 9.93179 5.43179L7.75 7.61358L5.56819 5.43179C5.39245 5.25605 5.10753 5.25605 4.93179 5.43179Z", fill: "currentColor", fillRule: "evenodd", clipRule: "evenodd" }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.Content, { className: "de-select-content", position: "popper", sideOffset: 4, children: /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.Viewport, { className: "de-select-viewport", children: options.map((option) => /* @__PURE__ */ jsxRuntime.jsxs(RadixSelect__namespace.Item, { value: option.value, className: "de-select-item", children: [
      /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.ItemText, { children: option.label }),
      /* @__PURE__ */ jsxRuntime.jsx(RadixSelect__namespace.ItemIndicator, { className: "de-select-item-indicator", children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M11.4669 3.72684C11.7558 3.91574 11.8369 4.30308 11.648 4.59198L7.39799 11.092C7.29783 11.2452 7.13556 11.3467 6.95402 11.3699C6.77247 11.3931 6.58989 11.3355 6.45446 11.2124L3.70446 8.71241C3.44905 8.48022 3.43023 8.08494 3.66242 7.82953C3.89461 7.57412 4.28989 7.55529 4.5453 7.78749L6.75292 9.79441L10.6018 3.90792C10.7907 3.61902 11.178 3.53795 11.4669 3.72684Z", fill: "currentColor", fillRule: "evenodd", clipRule: "evenodd" }) }) })
    ] }, option.value)) }) }) })
  ] });
});
...
var toastApi = {
  success: (msg) => sonner.toast.success(msg),
  error: (msg) => sonner.toast.error(msg),
  info: (msg) => sonner.toast(msg),
  warning: (msg) => sonner.toast.warning(msg)
};
var AD_SIZES = [
...
function Toolbar({
  ...
  const settingsContent = /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 700, fontSize: 12, color: "var(--color-primary)", textTransform: "uppercase", letterSpacing: "0.08em" }, children: "Editor Settings" }),
    [
      { label: "Grid overlay", key: "showGrid" },
      { label: "Snap to grid", key: "snapGrid" }
    ].map(({ label, key }) => /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 13, color: "var(--color-text)" }, children: label }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { borderTop: "1px solid var(--color-border)", paddingTop: 12 }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 11, color: "var(--color-text-muted)", marginBottom: 8, textTransform: "uppercase", letterSpacing: "0.06em" }, children: "Panel Rail" }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 6 }, children: ["left", "right"].map((side) => /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
      ...
      children: [
        onBack && /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(icons.ArrowLeftOutlined, { style: { fontSize: 11 } }),
              " ",
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "hidden md:inline", children: "Back" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginLeft: 8, marginRight: 4 }, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Redo (Ctrl+Y)", placement: "bottom", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => editor?.history.redo(), style: TOOL_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.RedoOutlined, {}) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(HDivider, {}),
        /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Zoom out", placement: "bottom", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => editor?.zoom.zoomOut(), style: TOOL_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.ZoomOutOutlined, {}) }) }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Zoom in", placement: "bottom", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: () => editor?.zoom.zoomIn(), style: TOOL_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.ZoomInOutlined, {}) }) }),
        /* @__PURE__ */ jsxRuntime.jsx(HDivider, {}),
        /* @__PURE__ */ jsxRuntime.jsx(
          ColorPickerBtn,
          {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          Popover,
          {
            ...
            placement: "bottom",
            content: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10, width: 220, padding: 4 }, children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 700, fontSize: 12, color: "var(--color-primary)", textTransform: "uppercase", letterSpacing: "0.07em" }, children: "Custom Canvas Size" }),
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "var(--color-text-muted)", fontWeight: 600 }, children: "\xD7" }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  antd.InputNumber,
                  {
                    min: 100,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: "primary", size: "sm", onClick: handleApplyCustom, style: { width: "100%" }, children: "Apply" })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          Popover,
          {
            ...
            placement: "bottom",
            children: /* @__PURE__ */ jsxRuntime.jsx("button", { style: TOOL_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.SettingOutlined, {}) })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Toggle layers panel", placement: "bottom", children: /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            onClick: onToggleLayers,
            style: layerPanelOpen ? TOOL_BTN_ACTIVE : TOOL_BTN,
            children: /* @__PURE__ */ jsxRuntime.jsx(icons.AppstoreOutlined, {})
          }
        ) }),
        /* @__PURE__ */ jsxRuntime.jsx(HDivider, {}),
        /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(icons.SaveOutlined, { style: { fontSize: 13 } }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "hidden md:inline", children: exporting ? "Saving\u2026" : "Save to Library" }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "md:hidden", children: exporting ? "\u2026" : "Save" })
            ]
          }
        )
      ]
...
function ColorPickerBtn({
  ...
  const pickerContent = /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      style: {
        width: 220,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
          ...
          gap: 8
        }, children: SWATCHES.map((sw) => /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            title: sw,
            onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 12, alignItems: "center", marginTop: 4 }, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", flex: 1 }, children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: { position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "var(--color-text-muted)", fontWeight: 600 }, children: "#" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                value: hex.replace(/^#/, ""),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Popover,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "inline-block" }, children: /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: tooltip, placement: "bottom", children: /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          style: {
            ...TOOL_BTN,
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "hidden md:inline", style: { fontSize: 11, fontWeight: 700, color: "var(--color-text-muted)" }, children: label })
          ]
        }
      ) }) })
    }
...
var ICONS = [
  ...
  { key: "elements", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.BlockOutlined, {}), label: "Elements" },
  { key: "upload", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.UploadOutlined, {}), label: "Upload" },
...
function IconRail({ activePanel, onTogglePanel }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: ICONS.map(({ key, icon, label }) => /* @__PURE__ */ jsxRuntime.jsx(
        RailButton,
        {
          icon,
          label,
...
var FrozenCanvas = React24.memo(
  function FrozenCanvas2({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { position: "absolute", inset: 0 }, children: /* @__PURE__ */ jsxRuntime.jsx("div", { ref: containerRef, style: { width: "100%", height: "100%", position: "relative" }, children: /* @__PURE__ */ jsxRuntime.jsx("canvas", { id: "layerhub_io_canvas" }) }) });
  },
  () => true
...
var CanvasArea = React24.memo(function CanvasArea2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      onDrop,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(CanvasContextBridge, { canvasBg }),
        dragOver && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
          position: "absolute",
          top: 16,
          left: "50%",
...
var TYPE_ICONS = {
  StaticImage: /* @__PURE__ */ jsxRuntime.jsx(icons.PictureOutlined, {}),
  BackgroundImage: /* @__PURE__ */ jsxRuntime.jsx(icons.PictureOutlined, {}),
  StaticText: /* @__PURE__ */ jsxRuntime.jsx(icons.FontSizeOutlined, {}),
  DynamicText: /* @__PURE__ */ jsxRuntime.jsx(icons.FontSizeOutlined, {}),
  StaticVideo: /* @__PURE__ */ jsxRuntime.jsx(icons.VideoCameraOutlined, {}),
  StaticPath: /* @__PURE__ */ jsxRuntime.jsx(icons.AppstoreOutlined, {}),
  StaticVector: /* @__PURE__ */ jsxRuntime.jsx(icons.AppstoreOutlined, {}),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
          ...
          selectedIds.size >= 2 && /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Group selected layers", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: handleGroup, style: ICON_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.FolderOutlined, { style: { fontSize: 12 } }) }) }),
          /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Close layers panel", children: /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              onClick: onClose,
              style: { ...ICON_BTN, color: "var(--color-text-muted)" },
              children: /* @__PURE__ */ jsxRuntime.jsx(icons.CloseOutlined, { style: { fontSize: 12 } })
            }
          ) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flex: 1, overflowY: "auto" }, children: layers.length === 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "32px 16px", textAlign: "center", color: "var(--color-text-muted)", fontSize: 12 }, children: [
          "No layers yet.",
          /* @__PURE__ */ jsxRuntime.jsx("br", {}),
          "Add content to the canvas."
        ] }) : layers.map((layer) => /* @__PURE__ */ jsxRuntime.jsx(
          LayerRow,
          {
            layer,
        ...
        children: [
          hasChildren ? /* @__PURE__ */ jsxRuntime.jsx(
            "span",
            {
              ...
              children: collapsed ? /* @__PURE__ */ jsxRuntime.jsx(icons.RightOutlined, {}) : /* @__PURE__ */ jsxRuntime.jsx(icons.DownOutlined, {})
            }
          ) : /* @__PURE__ */ jsxRuntime.jsx("span", { style: { width: 10 } }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 12, color: isActive ? "var(--color-primary)" : "var(--color-text-muted)", flexShrink: 0 }, children: TYPE_ICONS[layer.type] ?? /* @__PURE__ */ jsxRuntime.jsx(icons.AppstoreOutlined, {}) }),
          ...
          (hov || isActive) && !editing && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 1, flexShrink: 0 }, children: [
            /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: layer.visible ? "Hide" : "Show", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: (e) => {
              e.stopPropagation();
              onToggleVisible();
            }, style: ICON_BTN, children: layer.visible ? /* @__PURE__ */ jsxRuntime.jsx(icons.EyeOutlined, { style: { fontSize: 10 } }) : /* @__PURE__ */ jsxRuntime.jsx(icons.EyeInvisibleOutlined, { style: { fontSize: 10 } }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Duplicate", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: (e) => {
              e.stopPropagation();
              onCopy();
            }, style: ICON_BTN, children: /* @__PURE__ */ jsxRuntime.jsx(icons.CopyOutlined, { style: { fontSize: 10 } }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: "Delete", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: (e) => {
              e.stopPropagation();
              onDelete();
            }, style: { ...ICON_BTN, color: "var(--color-danger)" }, children: /* @__PURE__ */ jsxRuntime.jsx(icons.DeleteOutlined, { style: { fontSize: 10 } }) }) })
          ] })
        ]
      }
    ),
    hasChildren && !collapsed && layer.children.map((child) => /* @__PURE__ */ jsxRuntime.jsx(
      LayerRow,
      {
        layer: child,
        isActive: false,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 11, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Opacity" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "range",
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: 11, color: "var(--color-text)", minWidth: 30, textAlign: "right" }, children: [
          opacity,
          "%"
        ] }),
        isImage && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 6 }, children: [
              /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Flip horizontal", onClick: () => editor?.objects.update({ flipX: !activeObj?.flipX }), children: /* @__PURE__ */ jsxRuntime.jsx(icons.SwapOutlined, {}) }),
              /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Flip vertical", onClick: () => editor?.objects.update({ flipY: !activeObj?.flipY }), children: /* @__PURE__ */ jsxRuntime.jsx(icons.SwapOutlined, { style: { transform: "rotate(90deg)" } }) }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                PBtn,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(icons.ScissorOutlined, { style: { fontSize: 12 } }),
                    removingBg ? "Removing\u2026" : "Remove BG"
                  ]
                }
              )
            ] }),
            activeObj?.clipPath && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, marginTop: 4 }, children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Img Scale" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "range",
              ...
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Crop X/Y" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "range",
        ...
        isText && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(PDivider, {}),
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 11, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Color" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            PropertyColorPicker,
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            PBtn,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(icons.BoldOutlined, {})
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(
            PBtn,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(icons.ItalicOutlined, {})
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(PDivider, {}),
        ...
        (isShape || !isImage && !isText) && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(PDivider, {}),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 11, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Fill" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            PropertyColorPicker,
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 11, color: "var(--color-text-muted)", flexShrink: 0 }, children: "Stroke" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            PropertyColorPicker,
            {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(PDivider, {}),
        /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Bring forward", onClick: () => editor?.objects.bringForward(), children: /* @__PURE__ */ jsxRuntime.jsx(icons.VerticalAlignTopOutlined, {}) }),
        /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Send backward", onClick: () => editor?.objects.sendBackwards(), children: /* @__PURE__ */ jsxRuntime.jsx(icons.VerticalAlignBottomOutlined, {}) }),
        /* @__PURE__ */ jsxRuntime.jsx(PDivider, {}),
        /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Duplicate", onClick: () => editor?.objects.clone(), children: /* @__PURE__ */ jsxRuntime.jsx(icons.CopyOutlined, {}) }),
        /* @__PURE__ */ jsxRuntime.jsx(PBtn, { title: "Delete (Del)", onClick: () => editor?.objects.remove(), danger: true, children: /* @__PURE__ */ jsxRuntime.jsx(icons.DeleteOutlined, {}) })
      ]
    }
  );
}
...
function PropertyColorPicker({
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
          ...
          gridTemplateColumns: "repeat(7, 1fr)",
          gap: 6
        }, children: SWATCHES2.map((sw) => /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            title: sw,
            onClick: () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Popover,
    {
      content: pickerContent,
      placement: "top",
      children: /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: tooltip, placement: "top", children: /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          style: {
            height: 30,
...
function ShapesPanel({ onAddShape }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col h-full bg-surface", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-4 pt-4 pb-2", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center bg-[color-mix(in_srgb,var(--color-text)_5%,transparent)] rounded-lg px-3 py-2 border border-[var(--color-border)] focus-within:border-[var(--color-primary)] transition-colors", children: [
      /* @__PURE__ */ jsxRuntime.jsx(icons.SearchOutlined, { className: "text-[var(--color-text-muted)] mr-2" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 overflow-y-auto pb-6 scrollbar-hide px-4", children: [
      ...
      filteredShapes.length === 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-8 text-center text-[var(--color-text-muted)] text-sm", children: [
        'No shapes found for "',
        search,
        '"'
      ] })
...
function ShapeCategory({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-5", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-sm font-bold text-[var(--color-text)] tracking-tight", children: title }),
      hasMore && /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            ...
            expanded ? /* @__PURE__ */ jsxRuntime.jsx(icons.UpOutlined, { className: "ml-1 text-[10px]" }) : /* @__PURE__ */ jsxRuntime.jsx(icons.DownOutlined, { className: "ml-1 text-[10px]" })
          ]
        }
      )
    ] }),
    expanded ? (
      /* EXPANDED — 3-col grid */
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-3 gap-2 mt-1 auto-rows-fr", children: shapes.map((shape) => /* @__PURE__ */ jsxRuntime.jsx(
        ShapeTile,
        {
          shape,
          onClick: () => onAddShape(
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ScrollRow, { shapes, onAddShape })
    )
  ] });
}
function ScrollRow({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `.sticker-hscroll::-webkit-scrollbar { display: none; }` }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ref: scrollRef,
        ...
        children: shapes.map((shape) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "shrink-0", style: {
    ...
    canScrollRight && /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(icons.RightOutlined, { style: { fontSize: 10, color: "var(--color-text-muted)" } })
      }
    )
  ] });
}
function ShapeTile({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: shape.label, placement: "top", children: /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      onClick,
      draggable: true,
...
function StickersPanel({ onAddSticker }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col h-full bg-surface", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 overflow-y-auto pb-6 scrollbar-hide px-4", children: [
      ...
      filteredStickers.length === 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-8 text-center text-[var(--color-text-muted)] text-sm", children: [
...
function StickerCategory({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-5", children: [
    ...
    expanded ? (
      /* EXPANDED — 3-col grid */
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-3 gap-2 mt-1 auto-rows-fr", children: stickers.map((sticker) => /* @__PURE__ */ jsxRuntime.jsx(
        StickerTile,
        {
          sticker,
      ...
      /* COLLAPSED — horizontal scroll, scrollbar hidden, with arrow hint */
      /* @__PURE__ */ jsxRuntime.jsx(ScrollRow2, { stickers, onAddSticker })
    )
  ] });
}
function ScrollRow2({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        onScroll: checkScroll,
        children: stickers.map((sticker) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "shrink-0", style: {
          width: "calc((100% - 24px) / 4)"
        }, children: /* @__PURE__ */ jsxRuntime.jsx(
          StickerTile,
          {
...
function StickerTile({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { title: sticker.label, placement: "top", children: /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      onClick,
      draggable: true,
...
function UploadPanel({ onUploadFile }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: 14, display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        ref: fileInputRef,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          isUploading ? /* @__PURE__ */ jsxRuntime.jsx(icons.LoadingOutlined, { style: { fontSize: 32, color: "var(--color-primary)" } }) : /* @__PURE__ */ jsxRuntime.jsx(icons.CloudUploadOutlined, { style: { fontSize: 32, color: "var(--color-primary)" } }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { textAlign: "center" }, children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { color: "var(--color-text)", fontSize: 13, fontWeight: 600 }, children: isUploading ? "Uploading..." : "Click to upload" }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { color: "var(--color-text-muted)", fontSize: 11, marginTop: 4 }, children: "PNG \xB7 JPG \xB7 SVG \xB7 MP4 \xB7 max 50 MB" })
          ] })
        ]
      }
    ),
...
function ElementsPanel({
  ...
  const [textDesigns, setTextDesigns] = React24.useState([]);
  React24.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%", overflowY: "auto", padding: "8px 0 24px" }, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      Section,
      {
        title: "Text",
        ...
        children: [
          textDesigns.map((design) => /* @__PURE__ */ jsxRuntime.jsx(TextDesignThumb, { design, onClick: () => onApplyTextDesign(design) }, design.id)),
          textDesigns.length === 0 && /* @__PURE__ */ jsxRuntime.jsx(PlaceholderThumb, { label: "Text" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(Section, { title: "Shapes", count: SHAPES.length, onSeeAll: () => onSeeAll("shapes"), children: previewShapes.map((shape) => {
      const src = `https://cdn.jsdelivr.net/gh/fastlabai/design-editor/assets/shapes/${shape.category}/${shape.file}`;
      return /* @__PURE__ */ jsxRuntime.jsx(ImageThumb, { src, label: shape.label, onClick: () => onAddShape(src) }, shape.id);
    }) }),
    /* @__PURE__ */ jsxRuntime.jsx(Section, { title: "Stickers", count: STICKERS.length, onSeeAll: () => onSeeAll("stickers"), children: previewStickers.map((sticker) => {
      const src = `https://cdn.jsdelivr.net/gh/fastlabai/design-editor/assets/stickers/${sticker.category}/${sticker.file}`;
      return /* @__PURE__ */ jsxRuntime.jsx(ImageThumb, { src, label: sticker.label, onClick: () => onAddSticker(src) }, sticker.id);
    }) })
  ] });
}
function Section({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "12px 16px 0" }, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 13, fontWeight: 700, color: "var(--color-text)" }, children: title }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          onClick: onSeeAll,
          ...
          children: [
            ...
            displayCount,
            ") ",
            /* @__PURE__ */ jsxRuntime.jsx(icons.RightOutlined, { style: { fontSize: 9 } })
          ]
        }
      )
    ] }),
...
function TextDesignThumb({ design, onClick }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      ) : loading ? /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: "var(--color-text-muted)" }, children: "\u2026" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, color: "var(--color-text-muted)" }, children: design.name })
    }
  );
}
...
function DesignEditorInner({ onBack, initialScene, className, templatesPanel, title, textDesignProvider }) {
  ...
  const handleApplyTextDesign = React24.useCallback((design) => {
    if (!editor) return;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { "data-de-root": true, className, style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", background: "var(--de-color-bg)", color: "var(--de-color-fg)" }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, display: "flex", overflow: "hidden" }, children: [
      ...
      activePanel && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { width: 320, background: "var(--color-surface, var(--de-color-bg-elevated))", borderRight: "1px solid var(--color-border, var(--de-color-border))", display: "flex", flexDirection: "column", zIndex: 10 }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 12px 0 12px" }, children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 14, fontWeight: 600, textTransform: "capitalize", color: "var(--color-text)" }, children: activePanel }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }, children: [
          ...
          activePanel === "elements" && /* @__PURE__ */ jsxRuntime.jsx(
            ElementsPanel,
            {
              textDesignProvider,
          ...
          activePanel === "text" && /* @__PURE__ */ jsxRuntime.jsx(TextPanel, { provider: textDesignProvider, onApplyTextDesign: handleApplyTextDesign, onAddPlainText: (preset) => {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, position: "relative", overflow: "hidden" }, children: [
        ...
        activeObj && /* @__PURE__ */ jsxRuntime.jsx(
          ObjectPropertiesBar,
          {
            activeObj,
            editor,
      ...
      layerPanelOpen && /* @__PURE__ */ jsxRuntime.jsx(
        LayerPanel,
        {
          layers,
          activeId,
